...
$result=mysqli_query($conn,"SELECT * FROM objekwisata");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <a href="tambahdataobjekwisata.php" class="btn btn-success">(+)TAMBAH DATA</a>
        <div class="row">
        <table class="table table-striped">
    <thead class="thead-dark">
    <tr>
      <th scope="col">NOMOR DATA WISATA</th>
  ...
  <?php
    ...
    ?>
    <tr>
      <td><?php echo $nonim['nomordatawisata'] ?></td>
      <td><?php echo $nonim['namaobjekwisata'] ?></td>
      ...
      <td>
            <a href="editinformasipenduduk.php?nomordatawisata=<?php echo $nonim['nomordata']; ?>">EDIT</a>||
            <a href="hapusinformasipenduduk.php?nomordatawisata=<?php echo $nonim['nomordata']; ?>">HAPUS</a>
      </td>
    </tr>
