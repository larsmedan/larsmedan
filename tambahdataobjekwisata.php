...
<div class="card">
  <div class="card-body">
    ...
    <form class="row g-3" action="" method="post">
      <div class="col-12">
        <label  class="form-label">NOMOR DATA WISATA</label>
        <input type="text" class="form-control" name="nomordatawisata">
      </div>
      <div class="col-12">
        <label class="form-label">NAMA OBJEK WISATA</label>
        <input type="text" class="form-control" name="namaobjekwisata">
      </div>
      <div class="col-12">
    ...
    if(isset($_POST['save']))
    {
        $nomordata = $_POST['nomordatawisata'];
        $namapenghasilan = $_POST['namaobjekwisata'];
        ...
        $insert = mysqli_query($conn, "insert into penghasilanutama set nomordatawaisata='$nomordata', namaobjekwisata='$namapenghasilan', deskripsisingkat='$deskripsisingkat', deskripsilengkap='$deskripsilengkap',foto='$nama'");
        if($insert){
