...
<div class="card">
  <div class="card-body">
    ...
    <form class="row g-3" action="" method="post">
      <div class="col-12">
        <label  class="form-label">NOMOR DATA PENGHASILAN</label>
        <input type="text" class="form-control" name="nomordata">
      </div>
      <div class="col-12">
        <label class="form-label">NAMA PENGHASILAN</label>
        <input type="text" class="form-control" name="namapenghasilan">
      </div>
      <div class="col-12">
      ...
      <div class="col-12">
        <label  class="form-label">Deskripsilengkap</label>
        <textarea name="deskripsilengkap" class="form-control" cols="30" rows="10">
        </textarea>
      </div>
      <div class="col-12">
    ...
    if(isset($_POST['save']))
    {
        ...
        $namapenghasilan = $_POST['namapenghasilan'];
        ...
        $insert = mysqli_query($conn, "insert into penghasilanutama set nomordatapenghasilan='$nomordata', namapenghasilan='$namapenghasilan', deskripsisingkat='$deskripsisingkat', deskripsilengkap='$deskripsilengkap',foto='$nama'");
        if($insert){
