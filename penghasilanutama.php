...
$result=mysqli_query($conn,"SELECT * FROM penghasilanutama");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <a href="tambahpenghasilandata.php" class="btn btn-success">(+)TAMBAH DATA</a>
        <div class="row">
        <table class="table table-striped">
    <thead class="thead-dark">
    <tr>
      <th scope="col">NOMOR DATA PENGHASILAN</th>
  ...
  <?php
    ...
    ?>
    <tr>
      <td><?php echo $nonim['nomordatapenghasilan'] ?></td>
      <td><?php echo $nonim['namapenghasilan'] ?></td>
      <td><?php echo $nonim['deskripsisingkat'] ?></td>
      <td><?php echo $nonim['deskripsilengkap'] ?></td>
      <td> <img src="../foto/<?php echo $nonim['foto'] ?>" width="80%"></td>
      <td>
            <a href="editinformasipenduduk.php?nomordatapenghasilan=<?php echo $nonim['nomordatapenghasilan']; ?> ">EDIT</a>||
            <a href="hapusinformasipenduduk.php?nomordatapenghasilan=<?php echo $nonim['nomordatapenghasilan']; ?>">HAPUS</a>
      </td>
    </tr>
